...
type Regiment struct {
	...
	// use that slot.
	// TODO: check these docs. Does 65535 mean that? All units seem to have that value if there is no item equipped.
	MagicItems [3]uint16
	...
	unknown1 []byte // always 0x00 // TODO: maybe not always in save files
	unknown2 []byte // always 0x00 // TODO: maybe not always in save files
	unknown3 []byte // always 0x00 // TODO: maybe not always in save files
	unknown4 []byte
	unknown5 byte
	unknown6 []byte
	unknown7 []byte
